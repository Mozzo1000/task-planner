...
function Lists() {
  ...
  return (
    <Container>
      ...
      <Typography component={LinkMUI} onClick={handleOpenCompletedTasks}>
        Completed tasks {openCompletedTasks ? <ExpandLess /> : <ExpandMore />}
      </Typography>
            ...
            {completedTasks && (
              <>
                ...
                {!completedTasks.length && (
                  <Typography>
                    You have no completed tasks in this list.
                  </Typography>
                )}
              </>
            )}
