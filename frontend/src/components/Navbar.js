...
function Navbar() {
    ...
    const pages = [
        {name: 'Overview', link: "/", icon: <CalendarTodayIcon sx={{color: 'white'}}/>},
        {name: 'Planner', link: "/planner", icon: <ScheduleIcon sx={{color: 'white'}}/>},
        {name: 'Projects', link: "/projects", icon: <LayersIcon sx={{color: 'white'}}/>},
    ];
